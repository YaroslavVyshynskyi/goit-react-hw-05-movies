export const movies = {
  ...
  results: [
    ...
    {
      adult: false,
      backdrop_path: '/e9izudQBq4p3myvFSc0V7NkGuqV.jpg',
      id: 791155,
    ...
    {
      adult: false,
      backdrop_path: '/tLXdaL1yNnHtHFYrL1RAKwt7nPx.jpg',
      id: 698948,
    ...
    {
      adult: false,
      backdrop_path: '/rWqQBND7zbo0y4OtRZgXSsq57Xj.jpg',
      id: 132171,
      name: 'A Model Family',
      ...
      poster_path: '/jYRKeAL3nwQoZVjWPFoTQITEsKM.jpg',
      media_type: 'tv',
      genre_ids: [18],
      popularity: 34.178,
    ...
    },
    {
      ...
      poster_path: '/rYsPp89r2XqHm3tDuUHfeoce0PS.jpg',
      media_type: 'tv',
      genre_ids: [18],
      popularity: 24.551,
    ...
    },
    {
      ...
      poster_path: '/5PzmhMF5ekPWnC1IJHBHnL4Wokr.jpg',
      media_type: 'tv',
      genre_ids: [35],
      popularity: 173.705,
    ...
    {
      adult: false,
      backdrop_path: '/6oJtdTvMqpxS9sztOcmlAVdRZDI.jpg',
      id: 107005,
      name: 'A League of Their Own',
      original_language: 'en',
      original_name: 'A League of Their Own',
      overview:
      ...
      poster_path: '/3sqXMRpidT15QylW6GlQFuGpGCc.jpg',
      media_type: 'tv',
      genre_ids: [35, 18],
      popularity: 37.151,
      first_air_date: '2022-08-11',
    ...
    },
    {
      ...
      overview:
        "Waking up in the middle of his sleep in Eclector's Quadrant, Baby Groot finds a broken vial and traces the bubble-colored liquid from it around the ship. He later encounters Iwua, a shape-shifting alien who impersonates him. The pair dance, with the alien teaching him dance steps, until Groot ejects Iwua out of the ship via the airlock.",
    ...
    {
      adult: false,
      backdrop_path: '/45zyokriFFgS2GpkBeLQiiLpqvI.jpg',
      id: 1001692,
      title: 'Heartsong',
      original_language: 'tr',
      original_title: 'Gönül',
      overview:
      ...
      poster_path: '/lZquTg7Vz16nfvFPCwShTMqZiAO.jpg',
      media_type: 'movie',
      genre_ids: [10749, 35],
      popularity: 40.606,
      release_date: '2022-08-10',
    ...
    {
      adult: false,
      backdrop_path: '/iguArw0LyWt79ZwLBKVO8nHwAap.jpg',
      id: 673271,
      ...
      poster_path: '/bsIlZzfcwr9QKtXORaZ0kyh0nqi.jpg',
      media_type: 'movie',
      genre_ids: [10751, 10402, 18, 35],
      popularity: 31.238,
      release_date: '2022-08-12',
      video: false,
      vote_average: 7,
